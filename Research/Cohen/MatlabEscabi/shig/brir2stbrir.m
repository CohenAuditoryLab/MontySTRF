...
%   Fs          : Sampling Rate (Hz)
%   f1,f2       : Lower and upper cochleogram frequency
...
yl=conv(x,hl);
yr=conv(x,hr);
[CochDataX]=cochleogram(x,Fs,dX,f1,f2,MaxFm,OF,'log','n',ATT);
[CochDataYr]=cochleogram(yr,Fs,dX,f1,f2,MaxFm,OF,'log','n',ATT);
[CochDataYl]=cochleogram(yl,Fs,dX,f1,f2,MaxFm,OF,'log','n',ATT);
...
Sfr=CochDataYr.Sf;
Sfl=CochDataYl.Sf;
taxis=CochDataX.taxis;
faxis=CochDataX.faxis;
dt=taxis(2)-taxis(1);
