%
%function [CochData]=cochleogramduck(data,Fs,dX,f1,fN,Fm,Norm,dis,ATT)
%	
%	FILE NAME 	: COCHLEOGRAM
...
if strcmp(dis,'y')
     ...
     imagesc(CochData.taxis,log2(CochData.faxis./CochData.faxis(1)),CochData.S),set(gca,'YDir','normal')
