%
%function [p1,p2,p1e,p2e,p1i,p2i,spindex1,spindex2]=rtwstrfdbvar(STRF1,STRF2,
%	  SpecFile,T1,T2,spet,Trig,Fss,SPL,MdB,Sound,NBlocks,sprtype)
%
%       FILE NAME       : RT WSTRF DB VAR
%       DESCRIPTION     : Finds the Variability of the Envelope Patterns that
...
%
function [p1,p2,p1e,p2e,p1i,p2i,spindex1,spindex2]=rtwstrfdbvar(STRF1,STRF2,SpecFile,T1,T2,spet,Trig,Fss,SPL,MdB,Sound,NBlocks,sprtype)
