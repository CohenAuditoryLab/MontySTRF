...
if isfield(STRFBootData,'STRF1B')
    ...
    STRF1shuf=cat(3,STRFBootData.STRF1As,STRFBootData.STRF1Bs);
    STRF2shuf=cat(3,STRFBootData.STRF2As,STRFBootData.STRF2Bs);
...
for i=1:NB
     ...
     %Display Progress
     clc
     display(['Bootstrap itteration: ' int2str(i)])
