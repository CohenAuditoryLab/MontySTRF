%
% function []=cochleogramblock(OutFileHeader,data,Fs,dX,f1,fN,Fm,OF,TB,Norm,dis,ATT)
%	
%	FILE NAME 	: AUDIOGRAM BLOCK
%	DESCRIPTION : Takes sound specified by SoundFileName
%                 and computes the cochleogram in blocks of TB seconds. Saves
...
while count*NB<size(data,1)
    ...
    [AudData]=cochleogram(data((count-1)*NB+1:count*NB,:),Fs,dX,f1,fN,Fm,OF,Norm,dis,ATT);
