%
%function [CochioGramMS]=cochleogrammultiscale(data,Fs,dX,f1,fN,Fm,fm1,dfm,Nms,OF,Norm,MSflag,dis,ATT)
%	
%	FILE NAME 	: COCHLEOGRAM MULTI SCALE
%	DESCRIPTION : Computes the cochleogram and decomposes it for multiple
%                 "scales". Each scale consists of the filtered cochleogram
...
%
function [CochDataMS]=cochleogrammultiscale(data,Fs,dX,f1,fN,Fm,fm1,dfm,Nms,OF,Norm,MSflag,dis,ATT)
...
CochDataMS=CochData;
CochDataMS.Sms=SS;       %Corrected for envelope group delay
CochDataMS.SmsdB=SSdB;   %MS envelope in dB. Corrected for envelope group delay
CochDataMS.fml=fml;
CochDataMS.fmh=fmh;
CochDataMS.MSFilter=MSFilter;
CochDataMS.MSGroupDelay=MSGroupDelay;