%
%function [CorrData]=cochleogramchancorr(data,Fs,dX,f1,fN,Fm,OF,Norm,GDelay,dis,ATT)
%	
%	FILE NAME 	: COCHLEOGRAM CHAN CORR
%	DESCRIPTION : Computes the cochleogram channel correlation coefficient.
%
...
if strcmp(GDelay,'y')    %Corrected cochleogram is stored in 'data'
    S=CochData.Sc;        %Fixed 2/2/16, MAE
else
    S=CochData.S;         %Fixed 2/2/16, MAE
end
