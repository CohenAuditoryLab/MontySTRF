%function [CorrData]=cochleogramdynchancorr(data,Fs,dX,f1,fN,Fm,OF,dT,Overlap,Norm,GDelay,dis,ATT,ATTc)
%	
%	FILE NAME 	: cochleogramdynchancor
%	DESCRIPTION : Moves along the data in windows of size dT,
%                 Computes the short-term / dynamic cochleogram channel 
