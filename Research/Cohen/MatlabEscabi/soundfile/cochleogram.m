%
%function [CochData]=cochleogram(data,Fs,dX,f1,fN,Fm,OF,Norm,dis,ATT,FilterType,BWType)
%	
...
%                 Equivaslent Rectangular Bandwidth ('erb')
%                 Defaul == 'erb'
%
%RETURNED VARIABLES
%
...
CochData.Param.FilterType=FilterType;
