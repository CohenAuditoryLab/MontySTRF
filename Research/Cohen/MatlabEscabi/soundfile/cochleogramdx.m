%
%function [CochData]=cochleogramdx(data,Fs,dX,dXc,f1,fN,Fm,OF,Norm,dis,ATT)
%	
%	FILE NAME 	: COCHLEOGRAM DX
...
%                 model decomposition.
%
%                 This program is similar to COCHLEOGRAM except that it
...
%
function [CochData]=cochleogram(data,Fs,dX,dXc,f1,fN,Fm,OF,Norm,dis,ATT)
...
CochData.Filters=Filters;
CochData.FilterType=FilterType;
