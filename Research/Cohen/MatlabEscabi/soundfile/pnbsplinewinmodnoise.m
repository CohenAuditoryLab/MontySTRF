%
%function [X,Env,Fm]=pnbsplinewinmodnoise(BW,Fm,gamma,fc,D,p,T,Fs)
%
%   FILE NAME   : PERIODIC B SPLINE WIN MOD NOISE
...
%
% (C) Monty A. Escabi, March 20018ffxszZZ ,     
%
function [X,Env,Fm]=pnbsplinewinmodnoise(BW,Fm,gamma,fc,D,p,T,Fs,seed)
