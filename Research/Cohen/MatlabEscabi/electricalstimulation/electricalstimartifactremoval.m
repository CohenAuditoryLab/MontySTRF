...
%
%   X               : Matrix containing recorded channels - NxM (N =
%                     number of channels, M=number of samples)
%   S               : Matrix containing the input stimulus matrix - LxM
%                     (L = number of stimulatin channels; M = number of
%                     samples)
