...
%
% (C) Monty A. Escabi, March 2015 (Edit MAE Feb 2017)
%
...
Aud.Param.Fs=Fs;            %Edited to use actual sampling rate in data structure

%Converting Response Data to matrix format
N1=size(Aud,1);
N2=size(Aud,2);
N3=size(Aud,3);
[L1,L2]=size(cell2mat(Aud(1,1,1).Layer(L).Y));
